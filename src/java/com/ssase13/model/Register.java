...
import static com.ssase13.model.JsfLogin.log;
...
public class Register {
    ...
    public String registerUser(){
        ...
        {
            boolean test = Pattern.matches("\\w*",loginid);
            boolean test2 = Pattern.matches("\\w*", password);
            boolean test3 = Pattern.matches("\\w*", name);
            boolean test4 = Pattern.matches("\\w*", address); //test
    ...
    public ArrayList findIDbyName(String searchForName){
     ...
     //   ArrayList<int> foundIDS = new ArrayList<int>();
        ...
        for(int i = 0; i < foundIDS.size();i++){
            log.info("this matched "+i+":\t"+foundIDS.get(i));
        }
